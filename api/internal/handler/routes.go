...
import (
	...
	pmsproduct "simple_mall_new/api/internal/handler/pms/product"
	pmssku "simple_mall_new/api/internal/handler/pms/sku"
		...
		[]rest.Route{
			{
				Method:  http.MethodPost,
				Path:    "/",
				Handler: pmsproduct.SaveOrUpdateProductHandler(serverCtx),
			},
			{
				Method:  http.MethodPost,
				Path:    "/delete",
